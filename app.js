...
function loadPermanentEmployees() {
    // Lista vacía - esperando los empleados correctos del usuario
    const permanentEmployees = [
        // Los empleados se agregarán cuando el usuario los proporcione
    ];
...
function seedDemoEmployees() {
    // No agregar empleados automáticamente - dejar que el usuario los agregue manualmente
    console.log('Sistema listo para agregar empleados manualmente');
}
